...
# -*- coding: utf-8 -*-
# daily_panel_prep.py
# Prepare daily panel data from Cape Coral hurricane CSV for ARIMA/Prophet forecasting
...
def parse_args():
    ap = argparse.ArgumentParser(description="Prepare daily panel for Cape Coral hurricane forecasting")
    ap.add_argument("--input", 
                    default="cape_vbd3w_for_test.csv",
                    help="Input CSV with weekly hurricane data")
    ap.add_argument("--city", default="Cape Coral", help="City to process")
