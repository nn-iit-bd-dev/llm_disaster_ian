...
def parse_args():
    ...
    ap.add_argument("--input", default="ts_daily_panel_small/tampa_daily_panel.parquet",
                    help="Input daily panel (CSV or Parquet)")
    ap.add_argument("--city", default="Tampa", help="City name for outputs")
    ap.add_argument("--target", default="d14", choices=["d14","d21"],
                    help="Forecast target: day 14 or 21")
    ap.add_argument("--outdir", default="arima_forecasts_14_small", help="Output dir")
